...
const hi = {
  ...
  identity: {
    ...
    subtitle:
      'अपने आधार, पैन और बैंक दस्तावेज़ प्रबंधित करें, और जुड़ी सेवाओं को मेल में रखें।',
    score: 'पहचान स्वास्थ्य',
    attention: 'ध्यान देना है',
    consistent: 'सही',
    propagation: 'हम इन सिम्युलेटेड रिकॉर्ड को अपडेट करेंगे',
    confirm: 'सत्यापित करें और मेल कराएँ',
    success: 'सब कुछ मेल में है',
    successBody: 'आपके दस्तावेज़ हर जुड़ी सेवा में मेल खाते हैं।',
    receipt: 'बदलाव की रसीद',
    changedFrom: 'बदले गए अलग मान',
    changedTo: 'सत्यापित मान',
    ...
    correctEyebrow: 'वित्तीय पहचान · सत्यापित करें और मेल कराएँ',
    blocking: 'रोक रहा है',
    ...
    updatingDescription:
      'हर गंतव्य में सत्यापित मान को ट्रेस करने योग्य बनाए रखना।',
    ...
    alertsTitle: 'ध्यान देना है',
    documentAadhaar: 'आधार',
    documentPan: 'पैन',
    documentBank: 'बैंक खाता',
    aadhaarNumberLabel: 'आधार संख्या',
    panNumberLabel: 'पैन संख्या',
    ...
    editDeclaration:
      'मैं अपने {{document}} रिकॉर्ड में इस बदलाव की पुष्टि करता/करती हूँ।',
    declarationRequired: 'जारी रखने के लिए घोषणा स्वीकार करें।',
    continueToVerify: 'जारी रखें',
    otpSentBody:
      'हमने आपके {{document}} रिकॉर्ड में इस बदलाव को सत्यापित करने के लिए एक वन-टाइम कोड भेजा है।',
    verifyAndSave: 'सत्यापित करें और सहेजें',
    editSaved: 'सहेजा गया',
    editAlsoSynced: 'इससे इस मान वाले हर जुड़े रिकॉर्ड में भी बदलाव होगा।',
    connectedServices: 'जुड़ी सेवाएँ',
    connectedServiceSynced: 'मेल में है',
    connectedServiceNeedsSync: 'मेल कराना बाकी है',
    verifyAndSync: 'सत्यापित करें और मेल कराएँ',
    authorityTitle: 'इस मान के लिए {{source}} ही मूल स्रोत है',
    authorityBody:
      'आपके {{source}} रिकॉर्ड के वन-टाइम कोड से सत्यापन करने पर हर अन्य जुड़ा रिकॉर्ड इससे मेल खाने के लिए अपडेट होगा।',
    otp: 'मॉक ओटीपी',
    otpHint: '123456 का उपयोग करें',
  },
  auth: {
