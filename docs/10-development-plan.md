...
| `Flow-A-ITR-Filing-Spec-Revised-AY-2026-27.md` — “Core Architecture Rules,” “Tax Engine,” and “AY 2026–27 Reference Assumptions” | Original detailed source; verify its assumptions against official rules before implementation. |
...
| `Flow-A-ITR-Filing-Spec-Revised-AY-2026-27.md` — “Core Architecture Rules: Do Not Ask the User to Pick an ITR Form” and “Filing Route Engine” | Original eligibility requirements. |
...
| `Flow-A-ITR-Filing-Spec-Revised-AY-2026-27.md` — “Separate Income, Deductions, Tax and Tax Credits,” “Compute Both Regimes in Parallel,” and “Required Computation Pipeline” | Original detailed computation source. |
...
| `Flow-A-ITR-Filing-Spec-Revised-AY-2026-27.md` — Screens A0, A1, and A2 | Original field-level requirements. |
...
| `Flow-A-ITR-Filing-Spec-Revised-AY-2026-27.md` — Screen A3 | Original salary, pension, and validation requirements. |
...
| `Flow-A-ITR-Filing-Spec-Revised-AY-2026-27.md` — Screen A4 | Original property and loss-treatment requirements. |
...
| `Flow-A-ITR-Filing-Spec-Revised-AY-2026-27.md` — Screen A5 | Original capital-gain fields, classification, and route logic. |
...
| `Flow-A-ITR-Filing-Spec-Revised-AY-2026-27.md` — Screen A6 and “Example: Freelancer” | Original presumptive eligibility and regime-history requirements. |
...
| `Flow-A-ITR-Filing-Spec-Revised-AY-2026-27.md` — Screens A7 and A8 | Original category, deduction, and exempt-income requirements. |
...
| `Flow-A-ITR-Filing-Spec-Revised-AY-2026-27.md` — Screen A9 | Original deduction eligibility and metadata requirements. |
...
| `Flow-A-ITR-Filing-Spec-Revised-AY-2026-27.md` — Screen A10 | Original source, field, and validation requirements. |
...
| `Flow-A-ITR-Filing-Spec-Revised-AY-2026-27.md` — Screens A11 through A16 | Original calculation, bank, validation, filing, and confirmation requirements. |
...
| `Flow-A-ITR-Filing-Spec-Revised-AY-2026-27.md` — Screen A17 | Original notice, deadline, and remedy requirements. |
